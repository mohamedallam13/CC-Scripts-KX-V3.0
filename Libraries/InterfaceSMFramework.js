; (function (root, factory) {
  ...
  function InterfaceSheetObj(Sheet, paramObj) {
    ...
    paramObj.rangesOptionsArray.forEach((rangeOptions, i) => {
      ...
      var rangeObj = ISMFMethods[rangeOptions.type](rangeOptions, Sheet);
  ...
  var ISMFMethods = {
    ...
    OnTopRange: function (rangeOptions) {
      Object.assign(this, rangeOptions);
      var self = this;
      var rangesListAnn = [];
      this.clearRanges = [];
    ...
    SkipRange: function (rangeOptions) {
      Object.assign(this, rangeOptions);
      var self = this;
      var rangesListAnn = [];
      this.clearRanges = [];
    ...
    ListRange: function (rangeOptions) {
      Object.assign(this, rangeOptions);
      var self = this;
      var rangesListAnn = [];
      this.clearRanges = [];
    ...
    DefinedRange: function (rangeOptions) {
      Object.assign(this, rangeOptions);
      var self = this;
